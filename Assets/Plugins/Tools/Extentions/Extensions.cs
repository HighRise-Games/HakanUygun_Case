...
public static class IntegerExtensions
{
    ...
    {
        string abbreviated = Value.ToString();
        string suffix = "";
        string source = abbreviated;

        if (abbreviated.Length > 15)
        {
            abbreviated = abbreviated.Remove(abbreviated.Length - 15) + "." + source.Substring(abbreviated.Length - 15, 1);
            suffix = "Q";
        }
        else if (abbreviated.Length > 12)
        {
            abbreviated = abbreviated.Remove(abbreviated.Length - 12) + "." + source.Substring(abbreviated.Length - 12, 1);
            suffix = "T";
        }
        else if (abbreviated.Length > 9)
        {
            abbreviated = abbreviated.Remove(abbreviated.Length - 9) + "." + source.Substring(abbreviated.Length - 9, 1);
            suffix = "B";
        }
        else if (abbreviated.Length > 6)
        {
            abbreviated = abbreviated.Remove(abbreviated.Length - 6) + "." + source.Substring(abbreviated.Length - 6, 1);
            suffix = "M";
        }
        else if (abbreviated.Length > 3)
        {
            abbreviated = abbreviated.Remove(abbreviated.Length - 3) + "." + source.Substring(abbreviated.Length - 3, 1);
            suffix = "K";
        }
